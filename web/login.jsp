<%-- 
    Document   : login
    Created on : Dec 4, 2018, 2:07:55 PM
    Author     : hp
--%>
...
<body>
    <div class="container">
        <div class="jumbotron row">
          <center><h2><b>Selamat Datang</b></h2>
          <h4>Rumah Sakit Sehat Sentosa</h4></center>
        </div>
        <div class="row content">
          <div class="col-md-12">
            <div class="col-md-4 col-md-offset-4 daftar">
              <p class="form-title">Sign In</p>
              <form method="POST" action="/RumahSakit/LoginServlet" class="login">
